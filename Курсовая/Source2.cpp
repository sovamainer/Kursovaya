...
int idz(int mas[], const int size, bool flag) {
    if (flag) {
        cout << "Введите число, на которое нужно уменьшить каждый четный элемент:\n"
            "Число: ";
        ...
        cout << "Количество четных элементов с четными значениями: " << chet_num << endl << endl;
        cout << "Количество нечетных элементов с нечетными значениями: " << nechet_num << endl << endl;
        ...
        for (int j = 1; j < 10; j++) {
            ...
            cout << "Количество элементов, делящихся на  " << j << ": " << count << endl << endl;
        }
    }
    else {
        cout << "Массив не создан\n";
